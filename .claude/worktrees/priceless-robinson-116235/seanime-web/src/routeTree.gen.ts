...
const MainEnmasseAnimeIndexLazyRouteImport = createFileRoute(
  '/_main/enmasse-anime/',
)()
...
const MainUnmatchedIndexLazyRoute = MainUnmatchedIndexLazyRouteImport.update({
  id: '/unmatched/',
  path: '/unmatched/',
  getParentRoute: () => MainRoute,
} as any).lazy(() =>
...
const MainEnmasseMangaIndexLazyRoute =
  MainEnmasseMangaIndexLazyRouteImport.update({
    ...
    import('./routes/_main/enmasse-manga/index.lazy').then((d) => d.Route),
  )
const MainEnmasseAnimeIndexLazyRoute =
  MainEnmasseAnimeIndexLazyRouteImport.update({
    id: '/enmasse-anime/',
    path: '/enmasse-anime/',
    getParentRoute: () => MainRoute,
  } as any).lazy(() =>
    import('./routes/_main/enmasse-anime/index.lazy').then((d) => d.Route),
  )
...
const MainSettingsMangaScanIndexRoute =
  MainSettingsMangaScanIndexRouteImport.update({
    id: '/settings/manga-scan/',
    path: '/settings/manga-scan/',
    getParentRoute: () => MainRoute,
  } as any).lazy(() =>
    import('./routes/_main/settings/manga-scan/index.lazy').then(
      (d) => d.Route,
    ),
  )
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_main/unmatched/': {
      ...
      path: '/unmatched'
      fullPath: '/unmatched/'
      preLoaderRoute: typeof MainUnmatchedIndexLazyRouteImport
      parentRoute: typeof MainRoute
    }
    '/_main/torrent-list/': {
    ...
    '/_main/enmasse-manga/': {
      id: '/_main/enmasse-manga/'
      path: '/enmasse-manga'
      fullPath: '/enmasse-manga/'
      preLoaderRoute: typeof MainEnmasseMangaIndexLazyRouteImport
      parentRoute: typeof MainRoute
    }
    '/_main/enmasse-anime/': {
      id: '/_main/enmasse-anime/'
      path: '/enmasse-anime'
      fullPath: '/enmasse-anime/'
      preLoaderRoute: typeof MainEnmasseAnimeIndexLazyRouteImport
      parentRoute: typeof MainRoute
    }
    '/_main/debrid/': {
      id: '/_main/debrid/'
    ...
    '/_main/settings/manga-scan/': {
      id: '/_main/settings/manga-scan/'
      path: '/settings/manga-scan'
      fullPath: '/settings/manga-scan/'
      preLoaderRoute: typeof MainSettingsMangaScanIndexRouteImport
      parentRoute: typeof MainRoute
    }
    '/_main/profile/user/': {
