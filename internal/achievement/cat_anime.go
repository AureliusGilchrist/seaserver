...
var animeDefinitions = []Definition{
	...
	{Key: "a_commentator", Name: "Commentator", Description: "Post {threshold}+ comments on anime entries", Category: CategoryAnimeSocial, MaxTier: 10, TierThresholds: []int{10, 25, 50, 100, 250, 400, 800, 2000, 6000, 21000}, TierNames: t10, Triggers: []EvalTrigger{TriggerAny}},
