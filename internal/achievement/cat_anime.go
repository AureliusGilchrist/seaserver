...
var animeDefinitions = []Definition{
	...
	{Key: "a_non_stop", Name: "Non-Stop", Description: "Watch continuously for {threshold}+ hours", Category: CategoryAnimeBinge, MaxTier: 10, TierThresholds: []int{3, 6, 10, 16, 24, 30, 36, 42, 48, 72}, TierNames: t10, Triggers: []EvalTrigger{TriggerAnimeActivity}},
	...
	{Key: "a_back_to_back", Name: "Back to Back", Description: "Watch {threshold}+ episodes back to back without break", Category: CategoryAnimeBinge, MaxTier: 10, TierThresholds: []int{5, 10, 15, 20, 30, 40, 50, 60, 75, 100}, TierNames: t10, Triggers: []EvalTrigger{TriggerEpisodeProgress}},
	...
	{Key: "a_half_day_watch", Name: "Half-Day Watch", Description: "Watch 6+ hours of anime in a single day", Category: CategoryAnimeBinge, MaxTier: 0, Triggers: []EvalTrigger{TriggerAnimeActivity}},
	{Key: "a_full_day_watch", Name: "Full-Day Watch", Description: "Watch 12+ hours of anime in a single day", Category: CategoryAnimeBinge, MaxTier: 0, Triggers: []EvalTrigger{TriggerAnimeActivity}},
	...
	{Key: "a_no_sleep", Name: "No Sleep", Description: "Watch anime from 10PM to 6AM without stopping", Category: CategoryAnimeBinge, MaxTier: 0, Triggers: []EvalTrigger{TriggerAnimeActivity}},
	...
	{Key: "a_dawn_warrior", Name: "Dawn Warrior", Description: "Watch anime from midnight to dawn (6 AM consecutive)", Category: CategoryAnimeTime, MaxTier: 0, Triggers: []EvalTrigger{TriggerAnimeActivity}},
	...
	{Key: "a_forty_eight_hour", Name: "48-Hour Marathon", Description: "Watch anime for 48 cumulative hours in one week", Category: CategoryAnimeBinge, MaxTier: 0, Triggers: []EvalTrigger{TriggerAnimeActivity}},
	...
	{Key: "a_weekend_binge_hours", Name: "Weekend Binge Hours", Description: "Spend {threshold}+ hours watching on a single weekend", Category: CategoryAnimeTime, MaxTier: 10, TierThresholds: []int{3, 6, 10, 16, 24, 30, 36, 42, 48, 72}, TierNames: t10, Triggers: []EvalTrigger{TriggerAnimeActivity}},
	...
	{Key: "a_monthly_hours", Name: "Monthly Hours", Description: "Spend {threshold}+ hours watching anime in a single month", Category: CategoryAnimeTime, MaxTier: 10, TierThresholds: []int{10, 25, 50, 100, 200, 325, 650, 1600, 4800, 17000}, TierNames: t10, Triggers: []EvalTrigger{TriggerAnimeActivity}},
