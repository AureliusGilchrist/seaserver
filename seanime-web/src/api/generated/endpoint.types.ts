 ...
 */
export type SetAchievementShowcase_Variables = {
...
/**
 * - Filepath: internal/handlers/admin_announcements.go
 * - Filename: admin_announcements.go
 * - Endpoint: /api/v1/admin/announcements
 * @description
 * Route creates a new admin announcement. Admin only.
 */
export type CreateAdminAnnouncement_Variables = {
    message: string
 ...
 */
export type GetAnilistStaffDetails_Variables = {
    /**
     *  The AniList staff ID
     */
    id: number
}
...
/**
 * - Filepath: internal/handlers/anime_favorite.go
 * - Filename: anime_favorite.go
 * - Endpoint: /api/v1/library/favorites/toggle
 * @description
 * Route toggle an anime as favorite (add/remove).
 */
export type ToggleAnimeFavorite_Variables = {
    mediaId: number
}
 ...
 */
export type BulkAddAnimeFavorites_Variables = {
    mediaIds: Array<number>
}
...
/**
 * - Filepath: internal/handlers/anime_themes.go
 * - Filename: anime_themes.go
 * - Endpoint: /api/v1/anime-themes/{id}
 * @description
 * Route returns opening/ending themes for an anime.
 */
export type GetAnimeThemes_Variables = {
    /**
     *  The MyAnimeList ID
     */
    id: number
 ...
 */
export type GetAnilistCharacterDetails_Variables = {
    /**
     *  The AniList character ID
     */
    id: number
}
...
/**
 * - Filepath: internal/handlers/client_prefs.go
 * - Filename: client_prefs.go
 * - Endpoint: /api/v1/client-prefs
 * @description
 * Route creates or updates a client preference for the current profile.
 */
export type UpsertClientPref_Variables = {
    key: string
    value: string
}
...
/**
 * - Filepath: internal/handlers/comment.go
 * - Filename: comment.go
 * - Endpoint: /api/v1/comments
 * @description
 * Route create a new comment.
 */
export type CreateComment_Variables = {
    mediaId: number
    mediaType: string
    parentId?: number
    content: string
 ...
 */
export type EditComment_Variables = {
    content: string
}
 ...
 */
export type VoteComment_Variables = {
    value: number
}
...
/**
 * - Filepath: internal/handlers/entity_favorite.go
 * - Filename: entity_favorite.go
 * - Endpoint: /api/v1/character/favorites/toggle
 * @description
 * Route toggle a character as favorite (add/remove).
 */
export type ToggleCharacterFavorite_Variables = {
    characterId: number
}
 ...
 */
export type ToggleStaffFavorite_Variables = {
    staffId: number
}
 ...
 */
export type ToggleStudioFavorite_Variables = {
    studioId: number
}
...
/**
 * - Filepath: internal/handlers/kitsu_planning_slut.go
 * - Filename: kitsu_planning_slut.go
 * - Endpoint: /api/v1/kitsu/planning-slut/token
 * @description
 * Route saves the Planning Slut Kitsu token. Admin only.
 */
export type SaveKitsuPlanningSlutToken_Variables = {
    token: string
}
...
/**
 * - Filepath: internal/handlers/manga_favorite.go
 * - Filename: manga_favorite.go
 * - Endpoint: /api/v1/manga/favorites/toggle
 * @description
 * Route toggle a manga as favorite (add/remove).
 */
export type ToggleMangaFavorite_Variables = {
    mediaId: number
}
 ...
 */
export type BulkAddMangaFavorites_Variables = {
    mediaIds: Array<number>
}
 ...
 */
export type MangaScanManualLink_Variables = {
    folderName: string
    mediaId: number
}
...
/**
 * - Filepath: internal/handlers/planning_slut.go
 * - Filename: planning_slut.go
 * - Endpoint: /api/v1/planning-slut/token
 * @description
 * Route saves the Planning Slut AniList token. Admin only.
 */
export type SavePlanningSlutToken_Variables = {
    token: string
}
...
/**
 * - Filepath: internal/handlers/privacy.go
 * - Filename: privacy.go
 * - Endpoint: /api/v1/privacy/settings
 * @description
 * Route save privacy settings.
 */
export type SavePrivacySettings_Variables = {
    settings: Settings
}
...
/**
 * - Filepath: internal/handlers/profile.go
 * - Filename: profile.go
 * - Endpoint: /api/v1/profiles/login
 * @description
 * Route log in to a profile with PIN.
 */
export type ProfileLogin_Variables = {
    profileId: number
    pin: string
    anilistToken: string
}
 ...
 * @description
 * Route revalidate profile session with PIN (no AniList token required).
 */
export type RevalidateSession_Variables = {
    pin: string
}
 ...
 * @description
 * Route create a new profile (admin only).
 */
 ...
 */
export type UpdateProfile_Variables = {
    name?: string
    isAdmin?: boolean
    pin?: string
    themeId?: string
 ...
 * @description
 * Route set allowed library paths (admin only).
 */
export type SetAllowedLibraryPaths_Variables = {
    paths: Array<string>
}
 ...
 * @description
 * Route run the single-user to multi-profile migration.
 */
export type RunMigration_Variables = {
    profileName: string
    pin: string
}
 ...
 * @description
 * Route admin-only: set an AniList token for any profile.
 */
export type AdminSetProfileAniListToken_Variables = {
    token: string
}
 ...
 */
export type SetDisplayTitle_Variables = {
    title: string
    color: string
}
 ...
 */
export type SetDisplayCosmetics_Variables = {
    xpBarFillCss: string
...
/**
 * - Filepath: internal/handlers/reset_matches.go
 * - Filename: reset_matches.go
 * - Endpoint: /api/v1/library/reset-matches
 * @description
 * Route resets files matched to incorrect media IDs.
 */
export type ResetIncorrectMatches_Variables = {
    mediaIds: Array<number>
}
...
/**
 * - Filepath: internal/handlers/theme_music.go
 * - Filename: theme_music.go
 * - Endpoint: /api/v1/theme-music/search
 * @description
 * Route searches torrents for music/OST releases for a theme.
 */
export type SearchThemeMusic_Variables = {
    themeId: string
    query: string
 ...
 */
export type DownloadThemeMusic_Variables = {
    themeId: string
    magnetUrl: string
    provider: string
    torrent?: HibikeTorrent_AnimeTorrent
...
/**
 * - Filepath: internal/handlers/timeline.go
 * - Filename: timeline.go
 * - Endpoint: /api/v1/profile/timeline
 * @description
 * Route returns paginated timeline events with resolved media info.
 */
export type GetTimeline_Variables = {
    /**
     *  Page number (default 1)
     */
    page?: number
    /**
     *  Events per page (default 50)
     */
    pageSize?: number
}
...
/**
 * - Filepath: internal/handlers/track_preferences.go
 * - Filename: track_preferences.go
 * - Endpoint: /api/v1/mediastream/track-preferences
 * @description
 * Route Creates or updates a per-media track preference.
 */
export type UpsertTrackPreference_Variables = {
    mediaId: string
