...
import { AnilistLogo, AnilistTokenButton } from "@/components/shared/anilist-token-button"
            ...
            <Card className="md:py-10">
                <AppLayoutStack>
                    <div className="text-center space-y-4">
                        ...
                        <h3>Welcome!</h3>
                        <AnilistTokenButton leftIcon={<AnilistLogo />} intent="white" size="md" />
...
function ProfileAniListGate(props: {
    ...
    const loginButton = host === "127.0.0.1:43211" && !__isDesktop__
        ...
        >Link AniList</Button>
        : <AnilistTokenButton intent="white" size="md" />
