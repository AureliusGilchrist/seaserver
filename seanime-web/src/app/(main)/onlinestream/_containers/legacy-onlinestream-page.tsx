...
import { __onlineStream_episodeViewModeAtom } from "@/app/(main)/onlinestream/_containers/onlinestream-page"
import { useLegacyHandleOnlinestream } from "@/app/(main)/onlinestream/_lib/handle-onlinestream"
import { LegacyOnlinestreamManagerProvider } from "@/app/(main)/onlinestream/_lib/legacy-onlinestream-manager"
    ...
    return (
        ...
        >
            <LegacyOnlinestreamManagerProvider opts={opts}>
                ...
                />
            </LegacyOnlinestreamManagerProvider>
        </SeaMediaPlayerProvider>
    )
}
